...
from object_detection.model.utils.config import cfg, cfg_from_file, cfg_from_list
from object_detection.model.dataloader.roidb import combined_roidb
from object_detection.model.dataloader.sampler import sampler
...
from object_detection.model.utils.net_utils import weights_normal_init, save_net, load_net, \
...
if __name__ == '__main__':
    args = parse_args()
    args.cfg_file = "object_detection/cfgs/{}_ls.yml".format(args.net) if args.large_scale else "cfgs/{}.yml".format(args.net)
    ...
    # make variable, not necessary for torch-0.4.0 or later version
