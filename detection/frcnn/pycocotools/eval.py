...
from object_detection.model.dataloader.roidb import combined_roidb
from object_detection.model.dataloader.roibatchLoader import roibatchLoader
from object_detection.model.utils.config import cfg, cfg_from_file, cfg_from_list, get_output_dir
from object_detection.model.rpn.bbox_transform import clip_boxes
# from model.nms.nms_wrapper import nms
from object_detection.model.roi_layers import nms
from object_detection.model.rpn.bbox_transform import bbox_transform_inv
from object_detection.model.utils.net_utils import save_net, load_net, vis_detections
from object_detection.model.faster_rcnn.resnet import resnet
import warnings
...
def parse_args():
    ...
    parser.add_argument('--cfg', dest='cfg_file', help='optional config file',
                        default='object_detection/cfgs/res101.yml', type=str)
    parser.add_argument('--set', dest='set_cfgs', help='set config keys', default=None, nargs=argparse.REMAINDER)
    parser.add_argument('--load_dir', dest='load_dir', help='directory to load models', default="object_detection/models", type=str)
    ...
    parser.add_argument('--checkpoint', dest='checkpoint', help='checkpoint to load network', default=19323, type=int)
...
if __name__ == '__main__':
    ...
    elif args.dataset == 'vidvrd_ext':
        args.imdb_name = 'vidvrd_2020_train+vidvrd_2020_ext'
        args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
        args.imdbval_name = 'vidvrd_2020_test'
    elif args.dataset == 'vidvrd_coco':
        args.imdb_name = 'vidvrd_2020_train+vidvrd_2020_ext+vidvrd_2020_coco'
        args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
        args.imdbval_name = 'vidvrd_2020_test'
    elif args.dataset == 'vidor':
        args.imdb_name = 'vidor_2020_train'
        args.imdbval_name = 'vidor_2020_val'
        args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
    elif args.dataste == 'vidor_ext':
        args.imdb_name = 'vidor_2020_train+vidor_2020_ext+vidor_2020_coco'
        args.imdbval_name = 'vidor_2020_val'
        args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']

    args.cfg_file = "object_detection/cfgs/{}_ls.yml".format(args.net) if args.large_scale \
        else "object_detection/cfgs/{}.yml".format(args.net)
