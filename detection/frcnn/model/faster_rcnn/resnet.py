...
from .faster_rcnn import _fasterRCNN, _fasterRCNN_base
...
class resnet(_fasterRCNN):
    def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
        self.model_path = 'data/pretrained_model/resnet{:d}_caffe.pth'.format(num_layers)
    ...
    def base(self, im_data):
        return self.RCNN_base(im_data)
...
class resnet_base(_fasterRCNN_base):
    def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
        self.model_path = 'data/pretrained_model/resnet{:d}_caffe.pth'.format(num_layers)
        self.dout_base_model = 1024
        self.pretrained = pretrained
        ...
        _fasterRCNN_base.__init__(self, classes, class_agnostic)
