...
from frcnn.model.rpn.rpn import _RPN_FPN
from frcnn.model.rpn.proposal_target_layer_cascade import _ProposalTargetLayer
from frcnn.model.roi_layers import ROIAlign_FPN, ROIPool
...
class _FPN(nn.Module):
    ...
    def __init__(self, classes, class_agnostic):
        ...
        self.RCNN_roi_align = ROIAlign_FPN((cfg.POOLING_SIZE, cfg.POOLING_SIZE), 1.0/16.0, 0)
